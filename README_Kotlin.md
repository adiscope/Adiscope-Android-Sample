...
[![GitHub package.json version](https://img.shields.io/badge/Android-3.9.3-blue)](https://github.com/adiscope/Adiscope-Android-Sample/releases)
...
dependencies {
    ...
    implementation 'com.nps.adiscope:adiscopeCore:3.9.3'
