...
| 날짜          | 변경 사항                                                                                                                                                                                                                                                                                                                                                                                                                      |
|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2024/04/25  | 핫픽스 <br>adiscope-core  3.6.0 → 3.6.3 </br> RV 버그 수정 (isLoaded를 true로 반환하였으나 show fail이 발생하는 이슈 수정) </br>                                                                                                                                                                                                                                                                                                                   |
...
> _2023-04-25_
> * RV 버그 수정  
>  * RV에서 isLoaded를 true로 반환하였으나 show fail이 발생하는 이슈 수정

> ## Version 3.6.0
> _2023-04-05_
> * 어뷰징 방지를 위한 에뮬레이터 오퍼월 진입 제어 기능 추가
> * MAX 3rd party bidder 추가 (UnityAds)
> * AdmobDF 3rd party bidder 추가 (Pangle, Fan)
