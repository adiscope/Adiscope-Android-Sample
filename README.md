...
[![GitHub package.json version](https://img.shields.io/badge/Android-4.0.1-blue)](../../releases)
...
| chartboost | 21     | -       |                                                                                                                                           |
| max        | 21     | O       | admob, applovin, fan, mobvista, smaato,<br/>inmobi, pangle, verve, vungle, unityads,<br/>aps, bidmachine, ogury, moloco, google admanager |
| pangle     | 19     | -       |                                                                                                                                           |
| vungle     | 21     | -       |                                                                                                                                           |
...
* max 
  ...
  * (only max bidder) unityads, smaato, inmobi, verve, aps, bidmachine, ogury, moloco, google admanager
