...
dependencies {
    ...
    implementation 'com.nps.adiscope:adiscopeCore:2.1.4.0'
    ...
    implementation "com.nps.adiscope:adapter.pangle:4.7.0.5.2"        // pangle
    ...
    implementation 'com.nps.adiscope:adapter.vungle:6.11.0.1'        // vungle (use androidx)
